...
public class RecognizePlugin implements IPluginModule {
    ...
    public void init(Context context) {
        SpeechUtility.createUtility(context, SpeechConstant.APPID + "=581f2927"); //初始化
    }
    ...
    public void onClick(Fragment currentFragment, final RongExtension extension) {
        ...
        if (SpeechUtility.getUtility() == null) {
            SpeechUtility.createUtility(extension.getContext(), SpeechConstant.APPID + "=581f2927"); //初始化
        }
