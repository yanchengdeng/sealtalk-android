...
@MessageTag(value = "MY:TxtMsg", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class MyTextMessage extends MessageContent {
    private final static String TAG = "MyTextMessage";
    ...
    public static MyTextMessage obtain(String text) {
        MyTextMessage model = new MyTextMessage();
        model.setContent(text);
        return model;
    }

    public MyTextMessage(byte[] data) {
        String jsonStr = null;
        try {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ParcelUtils.writeToParcel(dest, getTime());
     ...
     */
    public MyTextMessage(Parcel in) {
        setExtra(ParcelUtils.readFromParcel(in));
        setTime(ParcelUtils.readIntFromParcel(in));
     ...
     */
    public static final Creator<MyTextMessage> CREATOR = new Creator<MyTextMessage>() {

        @Override
        public MyTextMessage createFromParcel(Parcel source) {
            return new MyTextMessage(source);
        }

        @Override
        public MyTextMessage[] newArray(int size) {
            return new MyTextMessage[size];
        }
    };
     ...
     */
    public MyTextMessage(String content) {
